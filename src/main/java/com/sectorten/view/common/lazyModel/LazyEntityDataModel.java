...
public class LazyEntityDataModel<T> extends LazyDataModel<T> {
    ...
    public List<T> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        if (this.facade != null) { // Handle data that needs to be retrieved from the data back-end of the application
            String sortOrderName = sortOrder != null ? sortOrder.toString() : null;

            this.itemList = this.facade.findRange(first, pageSize, sortField, sortOrderName, filters, searchingObject);
            this.setRowCount(this.facade.count(filters, searchingObject)); // Count ALL records for the applied filter
            setSelectedObject();
    ...
    public List<T> load(int first, int pageSize, List<SortMeta> multiSortMeta, Map<String, Object> filters) {
        ...
        itemList = this.facade.findRange(first, pageSize, sortFields, filters, searchingObject);
        this.setRowCount(this.facade.count(filters, searchingObject)); // Count ALL records for the applied filter
        setSelectedObject();
        return itemList;
    }
     ...
     * @param facade
     */
    public LazyEntityDataModel(AbstractDao<T> facade) {
        super();
        this.facade = facade;
        this.itemList = null;
    }

    public LazyEntityDataModel(AbstractDao<T> facade, T searchingObject) {
        super();
        this.facade = facade;
    ...
    public T getSearchingObject() {
        return searchingObject;
    }

    public void setSearchingObject(T searchingObject) {
        this.searchingObject = searchingObject;
    }
    ...
    public void setSelectedObject() {
        selectedObject = ((itemList != null && !itemList.isEmpty()) ? itemList.get(0) : null);
    }
